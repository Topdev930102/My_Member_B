...
router.post("/appointment/create_booking/:userId",verifySchool,appointment.CreateBooking)
router.put("/appointment/update_booking/:userId/:bookingId",verifySchool,appointment.UpdateBooking)
router.get("/appointment/get_bookings/:userId",verifySchool,appointment.getBooking)
router.delete("/appointment/delete_booking/:userId/:bookingId",verifySchool,appointment.deleteBooking)
